...
namespace Il2CppDumper
{
    public sealed class Metadata : BinaryStream
    {
        ...
        public Metadata(Stream stream) : base(stream)
        {
            ...
            {
                stringLiterals = ReadMetadataClassArray<Il2CppStringLiteral>(0xB3C54, (int)header.genericContainersOffset - 0xBA508); // see notes for how to get this
        ...
        public string GetStringFromIndex(uint index)
        {
            if (!stringCache.TryGetValue(index, out var result))
            {
                ...
                result = ReadStringToNull(0xA3C278 + index);
